...
public class RecommendationService {
    ...
    public TypeGroupedItemList recommendItems(UserEntity userEntity) {
        ...
        if (userEntity == null) { //in the case that user doesn't log in
        ...
        int gameSize = Math.min(gameIds.size(), MAX_GAME_SEED); //cap the size
        int perGameListSize = PER_PAGE_ITEM_SIZE / gameSize; //balance each gameId
